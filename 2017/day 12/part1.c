...
int solve_puzzle(char* file_name)
{
    ...
    programs[0].programs[0] = 1;
    recursive_fix(programs, program_id, &programs[0], 0);

    int32_t attached = count_attached(&programs[0]);
    printf("Program %d: Size: %d\n", 0, attached);
